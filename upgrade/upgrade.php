...
function shopstar_premium_admin_menu() {
    ...
    $shopstar_upgrade_page = add_theme_page(
    	...
    	'<span class="premium-link">'. __( 'Shopstar! Premium', 'shopstar' ) .'</span>',
    	'edit_theme_options',
    	'premium_upgrade',
...
function shopstar_load_upgrade_page_scripts( $hook ) {
    ...
    wp_enqueue_style( 'shopstar-font-awesome', get_template_directory_uri().'/library/fonts/otb-font-awesome/css/font-awesome.css', array(), '4.7.0' );
