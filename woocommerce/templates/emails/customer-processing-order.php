	...
	<td>
		<table border="0" cellpadding="0" align="center" cellspacing="0" width="500" style="background: #fff;font-family: 'Montserrat', sans-serif;padding: 20px;border-radius: 6px;box-shadow: 0 3px 6px 0 rgb(0 0 0 / 9%);border-collapse: initial; display: block;">
			<thead>                         
				...
				<tr><td valign="top" height="20"></td></tr>  
				<tr>
					<td valign="top" style="font-size: 14px; text-align: left; color: #000;font-weight: 400;">
				...
				<tr><td valign="top" height="20"></td></tr>  
				<tr>
					<td valign="top" style="font-size: 14px; text-align: left; color: #cb3d64;font-weight: 500;">
						Pay with <?php echo esc_html($order->get_payment_method_title()); ?>
					</td>
				</tr>
				<tr><td valign="top" height="8"></td></tr>  
				<tr>
					<td style="font-size: 13px; text-align: left; color: #00e447;font-weight: 400;" >
					<?php
						if ( $sent_to_admin ) {
